...
BDCans BreakdownTools::PIDVar(const char * mom_name, const int mom_nbins, const double mom_low, const double mom_high, const char pname, const char * can_title, const char * mom_title, const char * cuts){
    ...
    std::string mom_other = string(pname) + "_PDG != 2212 && TMath::Abs(" + string(pname) + "_PDG) != 211 && TMath::Abs(" + string(pname) + "_PDG) != 13 && ";
    mom_other += string(pname) + "_PDG != 111 && TMath::Abs(" + string(pname) + "_PDG) != 321 && " + string(pname) + "_PDG != 311 &&" + string(pname) + "_PDG != -999";
