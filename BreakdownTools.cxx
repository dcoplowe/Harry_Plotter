...
BDCans BreakdownTools::PIDVar(const char * mom_name, const int mom_nbins, const double mom_low, const double mom_high, const char * pname, const char * can_title, const char * mom_title, const char * cuts){
    ...
    THStack * mom_recon_tot = new THStack( (pname + "_" + can_title + "_recon").c_str() , mom_recon_title.c_str());
    THStack * mom_truth_tot = new THStack( (pname + "_" + can_title + "_truth").c_str(), mom_truth_title.c_str());
    THStack * mom_ratio_tot = new THStack( (pname + "_" + can_title + "_ratio").c_str(),  mom_ratio_title.c_str());
