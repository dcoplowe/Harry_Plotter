...
void Experiment::SetTopologies(Experiment::Name exp)
{
    if(exp == Experiment::MIN){
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNPNPiMinus, "truth_n_piP == 0 && truth_n_pro > 0 && truth_n_tau == 0 &&  mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNP, "truth_n_piP == 0 && truth_n_pro > 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNPiPlus, "truth_n_piP > 0 && truth_n_pro == 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNPNPiZero, "truth_n_piP == 0 && truth_n_pro > 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNPiZeroNPiPlus, "truth_n_piP > 0 && truth_n_pro == 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCKaonsOth, "truth_n_piP > 0 && truth_n_pro == 0 && truth_n_tau == 0 && mc_nFSParts > 0 || truth_n_piP > 0 || truth_n_pro > 0)");
    	m_topologies->AddSignalToTopology(Topology::CCKaonsOth, "truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNN, "truth_n_piP == 0 && truth_n_pro == 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNPNN, "truth_n_piP == 0 && truth_n_pro > 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNPiNN, "truth_n_pro == 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	m_topologies->AddSignalToTopology(Topology::CCNPiNPNN, "truth_n_pro > 0 && truth_n_tau == 0 && mc_nFSParts > 0");
    	...
    	// m_topologies->AddSignalToTopology(Topology::CC1Pi1PNN, "truth_n_pro > 0 && truth_n_tau == 0 && mc_nFSParts > 0");
...
m_symbol(ToString(m_type ,1)), m_fill_style(1001), m_line_colour(1), m_line_style(1)
{
	...
	if(m_type == Name::HCC1P1PiPlus){
		m_line_style = 2;
		m_line_colour = 1;
		m_fill_style = 0;
	}
    else if(Name::CC1P1PiPlus) m_fill_colour = (Int_t)DrawingStyle::T1P1PiP;//Proton
    else if(m_type == Name::CCNPNPiMinus) m_fill_colour = (Int_t)DrawingStyle::T1P1PiM;
	else if(m_type == Name::CCNP) m_fill_colour = (Int_t)DrawingStyle::T2Pr;
    else if(m_type == Name::CCNPiPlus) m_fill_colour = (Int_t)DrawingStyle::T2PiP;
    else if(m_type == Name::CCNPNPiZero) m_fill_colour = (Int_t)DrawingStyle::T1P1Pi0;
    else if(m_type == Name::CCNPiZeroNPiPlus) m_fill_colour = (Int_t)DrawingStyle::T1Pi1Pi0;
    else if(m_type == Name::CCKaonsOth){
    	m_fill_colour = (Int_t)DrawingStyle::T1P1PiM;
    	m_fill_style = 3008;
    }
    else if(m_type == Name::CCNN){
    	m_fill_style = 3009;
    	m_fill_colour = (Int_t)DrawingStyle::T2Pr;
    }
    else if(m_type == Name::CCNPNN){
    	m_fill_colour = (Int_t)DrawingStyle::T2PiP;
    	m_fill_style = 3019;
    }
    else if(m_type == Name::CCNPiNN){
    	m_fill_colour = (Int_t)DrawingStyle::T1P1Pi0;
    	m_fill_style = 3025;
    }
    else if(m_type == Name::CCNPiNPNN){
...
PDGInfo::PDGInfo(Int_t part_pdg, std::string part_name, std::string part_symbol) : m_pdg(part_pdg), m_name(part_name), m_symbol(part_symbol), m_line_colour(1), m_line_style(1) {
    ...
    else if(name.find("piminus") != std::string::npos)  m_colour = (Int_t)DrawingStyle::PionM;
    else if(name.find("pion") != std::string::npos)     m_colour = (Int_t)DrawingStyle::Pion;
    else if(name.find("amuon") != std::string::npos)    m_colour = (Int_t)DrawingStyle::MuonP;//PionP
    else if(name.find("muon") != std::string::npos)     m_colour = (Int_t)DrawingStyle::MuonM;
    else if(name.find("pizero") != std::string::npos)   m_colour = (Int_t)DrawingStyle::Pi0;
    else if(name.find("kapm") != std::string::npos)     m_colour = (Int_t)DrawingStyle::Kaon;
    else if(name.find("kazero") != std::string::npos)   m_colour = (Int_t)DrawingStyle::Ka0;
